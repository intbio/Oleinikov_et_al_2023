### NCP<sup><i>tt</i></sup><sub>CENP-C</sub> -Nucleosome core particle with CENP-C, 2nd run (PDB ID 4X23/1KX5)
...
<script>
  var pdb="trj/nrf_trj_for_web_cenpc2.pdb"
  var xtc="trj/nrf_trj_for_web_cenpc2.xtc"
  var csvfile="dat/nucl_CENPC_2_cont_unwrap.csv"
  var trjstep = 0.1;
